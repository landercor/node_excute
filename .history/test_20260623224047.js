...
app.use((req, res, next) => { // Funcion total del token Midlleware
    ...
    next() // --> seguir a la siguiente funsion Middleware
})

app.get('/', (req, res) => {//para renderizar nuestros archivos
    const { user } = req.session //pasamos las propiedades para renderizar
...
app.post('/logout', (req, res) => {
    res
    .clearCookie('access_token') //para cerrar la sesion se limpia la cookie
