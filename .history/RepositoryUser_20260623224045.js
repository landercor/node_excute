...
export class RepositoryUser {
    ...
    static async login ({ username, password}) {
        ...
        if (!isValid) throw new Error("password is invalid") //forma elejante de quitarle propiedades aun objetos
            const {password: _, ...publicUser } = user // omiti las propiedades privadas de los usuarios
